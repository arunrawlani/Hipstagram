...
class FriendSearchViewController: UIViewController {
    ...
    /*This is a local cache. Stores all the users that user is following.
    Used to update UI on immediate user interaction
    ...
    var query: PFQuery?{
        didSet{
            //Whenever assign new value, cancel previous requests
            oldValue?.cancel()
        }
    }
